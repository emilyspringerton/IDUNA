...
// --- carepyre ---
//
// MOVED to IDUNA_PRO, founder real-time 2026-09-08: "move the contact form to idunapro" (see
// main.go's own note on this). This admin page and its backing carepyre_contact_submissions
// reads are gone from IDUNA; the equivalent live view is IDUNA_PRO's console.html "Contact Form"
// panel, gated on contacts.manage instead of this file's own catch-all iduna.admin.
...
<nav>
  ...
  <a href="/admin/deadweight">DEADWEIGHT</a>
